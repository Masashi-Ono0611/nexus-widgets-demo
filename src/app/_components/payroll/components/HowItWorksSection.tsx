    ...
    <div className="space-y-4">
      ...
      <div className={`p-4 ${COLORS.backgroundSecondary} border ${COLORS.borderPrimary} rounded-lg`}>
        ...
        <ul className={`${COLORS.textTertiary} ${FONT_SIZES.bodySmall} space-y-1 ml-4`}>
          ...
          <li>• Choose wallet display colors</li>
          <li>• Configure DeFi strategies per wallet</li>
        </ul>
      </div>
      ...
      <div className={`p-4 ${COLORS.backgroundSecondary} border ${COLORS.borderPrimary} rounded-lg`}>
        ...
        <ul className={`${COLORS.textTertiary} ${FONT_SIZES.bodySmall} space-y-1 ml-4`}>
          ...
          <li>• Each wallet can have multiple strategies</li>
          <li>• Use sliders to adjust allocations easily</li>
        </ul>
      </div>
      ...
      <div className={`p-4 ${COLORS.backgroundSecondary} border ${COLORS.borderPrimary} rounded-lg`}>
        ...
        <ul className={`${COLORS.textTertiary} ${FONT_SIZES.bodySmall} space-y-1 ml-4`}>
          <li>• One-time: Execute distribution immediately</li>
          <li>• Recurring: Set up automated schedule</li>
          <li>• Configure intervals and max executions</li>
        </ul>
      </div>
